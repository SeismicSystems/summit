...
pub(crate) struct SummitDepositRpcServer {
    key_store_path: String,
    deposit_signature_domain: Digest,
}

impl SummitDepositRpcServer {
    pub(crate) fn new(key_store_path: String, genesis_hash: [u8; 32], namespace: &[u8]) -> Self {
        Self {
            key_store_path,
...
fn sign_deposit(
    ...
    let message = req.as_message(deposit_signature_domain);
...
#[async_trait]
impl SummitAdminApiServer for SummitDepositRpcServer {
