...
mod tests {
    ...
    fn test_subject_hash() {
        ...
        let r1 = Request::<D>::Finalized { height: 100 };
        let r2 = Request::<D>::Finalized { height: 100 };
        let r3 = Request::<D>::Finalized { height: 200 };
    ...
    fn test_subject_predicate() {
        let r1 = Request::<D>::Finalized { height: 100 };
        let r2 = Request::<D>::Finalized { height: 200 };
        ...
        let r1_same = Request::<D>::Finalized { height: 100 };
    ...
    fn test_encode_size() {
        ...
        let r2 = Request::<D>::Finalized { height: u64::MAX };
        let r3 = Request::<D>::Notarized {
    ...
    fn test_request_ord_same_variant() {
        ...
        let fin1 = Request::<D>::Finalized { height: 100 };
        let fin2 = Request::<D>::Finalized { height: 200 };
        let fin3 = Request::<D>::Finalized { height: 200 };
    ...
    fn test_request_ord_cross_variant() {
        ...
        let finalized = Request::<D>::Finalized { height: 100 };
    ...
    fn test_request_ord_sorting() {
        ...
        assert_eq!(sorted[3], Request::<D>::Finalized { height: 100 });
        assert_eq!(sorted[4], Request::<D>::Finalized { height: 200 });
    ...
    fn test_request_ord_edge_cases() {
        ...
        let min_finalized = Request::<D>::Finalized { height: 0 };
        let max_finalized = Request::<D>::Finalized { height: u64::MAX };
